package net.mcreator.nexustest.mixins;
...
public abstract class NexustestModRepairItemRecipeMixin {
	...
	public void assemble(CraftingContainer craftingContainer, CallbackInfoReturnable<ItemStack> cir) {
		...
		if ((itemStack3 = (ItemStack) list.get(0)).is((NexustestModItems.FLASH_SWORD))) {
